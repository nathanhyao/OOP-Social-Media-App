...
/***********************************************************************************************************************
 * PixieLoginPage.java: Contains panel layouts for login JFrame interface: A panel for when the user wants to sign in.
 * Another panel for when the user wants to create an account.
 *
 * @author Nathan Yao
