...
/***********************************************************************************************************************
 * DataManagement.java: Handles all data calls, setters and getters for the files. Create an instance of this if you
 * need a profile or anything from the files (csv database).
 *
...
public class DataManagement {
    ...
    public ArrayList<Post> getAllPosts() {
		...
		for (String[] recentPost : recentPosts) {
			if (recentPost.length > 0) {
				postList.add(toPost(recentPost));
			}
		}
