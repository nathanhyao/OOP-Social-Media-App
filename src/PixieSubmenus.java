...
/***********************************************************************************************************************
 * PixieSubmenus.java: Contains the submenu layouts that the user can see when s/he clicks on each of the main menu
 * options after creating new account or signing in.
 *
 * @author Nathan Yao
