...
/***********************************************************************************************************************
 * Server.java: Each client connects to Server. While Server is running, it is constantly open to new client
 * connections. Server will initialize a thread for each client that is constantly listening for requests from that
 * respective client. Server will write back requested information.
 *
