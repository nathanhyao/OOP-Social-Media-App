...
/***********************************************************************************************************************
 * PixieYourProfile.java: Contains all panel setups for "Your Profile" page from the main menu options.
 *
 * @author Nathan Yao
...
public class PixieYourProfile extends JComponent {
    ...
    private void changePasswordPage() {
        ...
        //add them to the changePasswordPanel in correct order
    ...
    private void yourProfilePage() {
        ...
        yourProfileBioLabel = new JLabel("<html>your bio stuff goes here i think." +
                "Here's to test what the scroll pane is like." +
                "Here's just more test text." +
