...
/***********************************************************************************************************************
 * PixieSearchUser.java: Contains basic panel layouts for search user function. Includes: search user option panel and
 * buttons. Search user function will also use PixieViewPost -- container panel for displaying posts and comments
 *
 * @author Nathan Yao
...
public class PixieSearchUser extends JComponent {
    ...
    Color subMenuColor = new Color(57, 60, 127, 255);
